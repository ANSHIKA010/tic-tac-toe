...
import com.attech.tictactoe.models.User;
        ...
        database.getReference().child("Game").child(gameId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(game.getPlayer1Id().equals(player1)){
                    player1Sign[0] = game.getPlayer1sign();
                    player2Sign[0] = game.getPlayer2sign();
                }
                else {
                    player1Sign[0] = game.getPlayer2sign();
                    player2Sign[0] = game.getPlayer1sign();
                }
